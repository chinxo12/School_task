        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Capacity = table.Column<int>(type: "int", nullable: false, defaultValue: 1000),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatorId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Schools_Users_CreatorId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Classes_ClassName_FacultyId",
                table: "Classes",
                columns: new[] { "ClassName", "FacultyId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Faculties_FacultyName_SchoolId",
                table: "Faculties",
                columns: new[] { "FacultyName", "SchoolId" },
                unique: true);
